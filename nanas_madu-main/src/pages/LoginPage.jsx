  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-[#FAFDFB] overflow-hidden select-none font-sans relative">
          ...
          <div className="my-auto py-12">
            ...
            >
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-white/10 border border-white/20 backdrop-blur-sm text-golden-light mb-6 uppercase tracking-wider">
                <IoSparklesOutline className="animate-spin text-[14px]" /> 100% Madu Nanas Asli
              </span>
              <h1 className="text-4xl xl:text-5xl font-extrabold leading-tight tracking-tight text-white mb-6">
                Kemurnian Alami <br />
                <span className="text-gradient-gold drop-shadow-md">Khas Pemalang</span>
              </h1>
              <p className="text-white/80 text-base leading-relaxed mb-8 max-w-md">
                Masuk ke akun Anda dan rasakan kemudahan memesan olahan nanas madu premium terbaik langsung dari petani lokal kami.
              </p>
            </motion.div>
            ...
            >
              <div className="bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl p-4 transition-all duration-300 hover:bg-white/15 hover:translate-y-[-2px]">
                ...
                <h4 className="text-sm font-bold text-white">Kualitas Premium</h4>
                <p className="text-xs text-white/60 mt-1">Teruji & tersertifikasi higienis.</p>
              </div>
              <div className="bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl p-4 transition-all duration-300 hover:bg-white/15 hover:translate-y-[-2px]">
                <IoHeartOutline className="text-golden-light text-2xl mb-2" />
                <h4 className="text-sm font-bold text-white">Bantu Petani</h4>
                <p className="text-xs text-white/60 mt-1">Setiap pembelian membantu petani lokal.</p>
              </div>
            </motion.div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-hidden bg-[#FAFDFB]">
        ...
        {/* Dynamic Moving Colorful Glass Blobs behind the card (Creates high-end Glassmorphism) */}
        <motion.div
          animate={{
            x: [0, 80, -40, 0],
            y: [0, -60, 40, 0],
        ...
        />
        <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-brand-pale/20 blur-[90px] pointer-events-none" />
        ...
        >
          ...
          <div className="bg-white/80 border border-white/50 backdrop-blur-2xl rounded-3xl p-8 sm:p-10 shadow-[0_25px_55px_rgba(5,150,105,0.06),_0_10px_20px_rgba(5,150,105,0.02)] relative overflow-hidden">
            ...
            <div className="flex flex-col items-center mb-8 text-center">
              <Link to="/" className="lg:hidden flex items-center gap-1.5 mb-6 outline-none">
                <img src={logoImg} alt="Honea Logo" className="h-12 w-auto object-contain" />
                <div className="flex flex-col text-left leading-none">
                  <span className="font-extrabold text-[20px] tracking-tight text-gray-900 leading-[1.1]">Honea</span>
                  <span className="text-[8px] font-bold tracking-[0.1em] text-brand-dark uppercase mt-0.5">Asli Khas Pemalang</span>
                </div>
              </Link>
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="block w-full pl-11 pr-12 py-3 rounded-2xl bg-white/90 border border-gray-200/80 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-brand/10 focus:border-brand transition-all duration-300 shadow-sm"
                    required
                  />
                  <button
                    type="button"
              ...
              >
                <label className="flex items-center gap-2 cursor-pointer text-gray-600 font-semibold select-none group">
                  <input
                    ...
                    className="h-4.5 w-4.5 rounded-lg border-gray-300 text-brand focus:ring-brand/20 cursor-pointer transition-colors duration-300 accent-brand"
                  />
                  <span className="group-hover:text-gray-900 transition-colors">Ingat saya</span>
                </label>
                <Link
                  to="/forgot-password"
                  className="font-bold text-brand hover:text-brand-dark transition-colors duration-300 underline-offset-4 hover:underline"
                >
                  Lupa Sandi?
                </Link>
              </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-white hover:bg-gray-50 text-gray-700 text-sm font-bold border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-300 active:scale-[0.99] outline-none disabled:opacity-60 disabled:pointer-events-none"
              >
