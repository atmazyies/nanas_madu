...
export default function ManfaatKesehatanPage() {
  ...
  return (
    <>
      <Navbar />
      <PageBanner
        title="Manfaat Kesehatan Nanas Madu"
        subtitle="Eksplorasi khasiat terapeutik, kandungan nutrisi, dan bukti studi ilmiah di balik manisnya Nanas Madu premium Honea."
        breadcrumbs={[{ label: "Keunggulan", href: "/uvp" }, { label: "Manfaat Kesehatan" }]}
      />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-12 lg:grid-cols-3 mb-24">
            ...
            <motion.div
              ...
              className="glass rounded-3xl p-8 shadow-[var(--shadow-card)] border border-white/50 relative overflow-hidden"
            >
            ...
            <div className="grid gap-6">
              {journalReferences.map((ref) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="glass rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-start gap-6 hover:shadow-md transition-shadow"
                >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {faqs.map((faq, idx) => (
                <div
                  key={idx}
                  className="rounded-2xl bg-white border border-gray-100 p-6 shadow-sm cursor-pointer"
